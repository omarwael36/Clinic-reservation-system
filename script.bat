...
docker logs databasecont


docker run --name front-container -d -p 4200:80 -e API_URL=http://localhost:4200

docker run --name backend-container -p 8080:8080 --network mynetwork -d -e DB_HOST=databasecont -e DB_PORT=3306 -e DB_USER=root -e DB_PASSWORD=12345678 -e DB_NAME=clinic_reservation_system -e PORT=8080 backend-image
